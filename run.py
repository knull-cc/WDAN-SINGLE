...
parser.add_argument('--pred_loss_weight', type=float, default=1.0,
                    help='weight for prediction loss during joint training')
parser.add_argument('--stats_loss_weight', type=float, default=0.5,
                    help='weight for statistics prediction loss during joint training')
parser.add_argument('--joint_training_only', type=int, default=1,
                    help='1: 全程单阶段联合训练; 0: 保留分阶段训练流程')
